...
export default function ImagePost() {
  return (
   ...
   <div className="absolute top-0 left-0 w-full h-full flex justify-center items-center lg:justify-start lg:items-end bg-black/[0.3] text-white hover:bg-black/[0.4] tranform-ease-in-out duration-300">
       <div className=" p-2 lg:p-8 w-full">
        ...
        <div className="flex text-gray-200 hidden md:block md:font-xs">

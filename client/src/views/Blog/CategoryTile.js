...
const CategoryWeigdet = ({title, slug}) => (
    ...
    <Link to={`/blog/${slug}`} className="px-2 py-2 my-2 border-2 shadow flex justify-between items-center scale-95 hover:scale-100 duration-200 origin-center hover:origin-top">
